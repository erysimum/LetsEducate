      ...
      <Modal basic open={open} onClose={closeModal}>
        ...
        <Modal.Content>
          <Form onSubmit={this.handleSubmit}>
            <Form.Field>
              <Input fluiduser label='Video Topic/Category' name='videoTopic' value={videoTopic} onChange={this.handleChange} />
            </Form.Field>
            <Form.Field>
              <Input label='Video Title' name='videoTitle' value={videoTitle} onChange={this.handleChange} />
            </Form.Field>
            <Form.Field>
              <Input fluid label='Video Link' name='videoLink' value={videoLink} onChange={this.handleChange} />
            </Form.Field>
          </Form>
          {message && (
